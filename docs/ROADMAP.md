...
#### 9. Local email/password accounts + role-based access control (SOURCE-COMPLETE 2026-09-06 — pending one live browser click-through before this item can close)
- **Category:** Security & Identity
